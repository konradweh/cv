...
\newcommand{\cvlanguage}[5]{%
  ...
  \begingroup
    % Keep this block compact and stable regardless of global \parskip
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \draw[cvblue, line width=1.0pt]
    ...
    ([xshift=10mm+\SepLineX, yshift=40mm]current page.south west);
  ...
  \smash{%
    \begin{tikzpicture}[remember picture,overlay]
      \node[anchor=north west, align=left] at
        ([xshift=12mm+\RightColX,yshift=-11mm]current page.north west)
      {%
