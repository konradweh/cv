...
\begin{tikzpicture}[remember picture,overlay]
  ...
  % Photo block
  \coordinate (PhotoNE) at ([xshift=-\PhotoOffset - \PhotoW,yshift=-\PhotoOffset]current page.north east);
  \node[anchor=north west, fill=white, inner sep=0pt] at (PhotoNE)
  {%
