...
\begin{tikzpicture}[remember picture,overlay]
  ...
  % Photo block
  \coordinate (PhotoNE) at ([xshift=-8mm - \PhotoW,yshift=-\PhotoOffset]current page.north east);
  \node[
    anchor=north west
  ] at (PhotoNE)
  {%
    \begin{minipage}[t][\PhotoH][c]{\PhotoW}
      \centering
      \includegraphics[width=0.9\PhotoW,height=0.9\PhotoH,keepaspectratio]{portrait_circle.png}
    \end{minipage}%
  };
  ...
  \smash{%
    \begin{tikzpicture}[remember picture,overlay]
      \node[anchor=north west, align=left] at
        ([xshift=10mm,yshift=-8.5mm]current page.north west)
      {%
